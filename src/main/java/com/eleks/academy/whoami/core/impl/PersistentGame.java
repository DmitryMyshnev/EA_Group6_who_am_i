...
public class PersistentGame implements SynchronousGame {
    ...
    public static final long SUGGESTING_CHARACTER_TIMEOUT = TimeUnit.DAYS.toMillis(1);//20;
    public static final long WAITING_QUESTION_TIMEOUT = TimeUnit.DAYS.toMillis(1);//60;
    public static final long WAITING_GUESS_TIMEOUT = TimeUnit.DAYS.toMillis(1);//60;
    public static final long WAITING_ANSWER_TIMEOUT = TimeUnit.DAYS.toMillis(1);//20;
